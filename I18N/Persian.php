 ...
 * ----------------------------------------------------------------------
 *
 * Class Name: PHP and Persian Language
 *
 ...
 * ----------------------------------------------------------------------
 *
 * @desc   Set of PHP classes developed to enhance Persian web
 *         applications by providing set of tools includes stem-based searching,
 *         translitiration, soundex, Hijri calendar, charset detection and
 *         converter, spell numbers, keyboard language, Muslim prayer time,
 *         auto-summarization, and more...
...
/**
 * Core PHP and Persian language class
 *
 * @category  I18N
 * @package   I18N_Persian
 * @author    Alireza Yusefi <rayansys.rs@gmail.com>
 * @copyright 2022-2025 Alireza Yusefi
 *
 * @license   LGPL <http://www.gnu.org/licenses/lgpl.txt>
 * @link      http://www.ar-php.org
 */
...
class I18N_Persian
{
    ...
    private $_compatible = array('ArGlyphs'=>'Glyphs');
    ...
    public static function myErrorHandler($errno, $errstr, $errfile, $errline)
    {
        if ($errfile == __FILE__
            || file_exists(
                dirname(__FILE__).DIRECTORY_SEPARATOR.'Persian'.
    ...
    /**
     * Convert Persian string from one charset to another
     *
     * @param string $str           Original Persian string that you would like
     *                              to convert
     * @param string $inputCharset  Input charset
     * @param string $outputCharset Output charset
     *
     * @return string Converted Persian string in defined charset
     * @author Khaled Al-Shamaa <khaled@ar-php.org>
     */
    public function coreConvert($str, $inputCharset, $outputCharset)
    {
        if ($inputCharset != $outputCharset) {
            ...
            if ($convStr == '' && $str != '') {
                ...
                $c = I18N_Persian_CharsetC::singleton();
    ...
    /**
     * Convert Persian string from one format to another
     *
     * @param string $str           Persian string in the format set by setInput
     *                              Charset
     ...
     *
     * @return string Persian string in the format set by method setOutputCharset
     * @author Khaled Al-Shamaa <khaled@ar-php.org>
     */
